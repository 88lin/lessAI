...
assertIncludes(settingsConstants, 'baseUrl: "https://cliproxy.eqing.tech/v1"');
assertIncludes(rustDomainModels, 'base_url: "https://cliproxy.eqing.tech/v1".to_string()');
assertIncludes(settingsConstants, 'model: "gpt-5.5"');
assertIncludes(rustDomainModels, 'model: "gpt-5.5".to_string()');
