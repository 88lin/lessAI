...
- Stable base version in repo config: `0.3.6`
...
2. Publishes the first fork release as `v0.3.6` if that tag does not exist.
3. Publishes later fork releases as `v0.3.6.1`, `v0.3.6`, and so on.
4. Uses Tauri-compatible internal versions such as `0.3.6` and `0.3.6-1`.
