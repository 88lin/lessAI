...
- Stable base version in repo config: `0.3.10`
...
2. Publishes the first fork release as `v0.3.10` if that tag does not exist.
3. Publishes later fork releases as `v0.3.10.1`, `v0.3.10.2`, and so on.
4. Uses Tauri-compatible internal versions such as `0.3.10` and `0.3.10-1`.
